...
class UserVerifyTest(BaseTest):
    def test_user_ctivates_success(self):
        user=User.objects.create_user('testuser','testuser1@restaurantesigloxxi.com')
        user.set_password('portafolio')
        ...
        self.assertEqual(response.status_code,302)
        user=User.objects.get(email='testuser1@restaurantesigloxxi.com')
